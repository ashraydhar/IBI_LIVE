...
import com.zeplin.AppConstants;
import com.zeplin.R;
...
public class HomeFragement extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        tvdiscover = (TextView) view.findViewById(R.id.toolbar_tv_discover);
        tvmap = (TextView) view.findViewById(R.id.toolbar_tv_map);
        tvpost = (TextView) view.findViewById(R.id.toolbar_tv_myPost);
        tvrequest = (TextView) view.findViewById(R.id.toolbar_tv_request);
        tvnetwork = (TextView) view.findViewById(R.id.toolbar_tv_myNetwork);
        tvheader = (TextView) view.findViewById(R.id.tv_header);
        linear1 = (LinearLayout) view.findViewById(R.id.toolbar_linear1);
        linear2 = (LinearLayout) view.findViewById(R.id.toolbar_linear2);
        linear3 = (LinearLayout) view.findViewById(R.id.toolbar_linear3);
        linear4 = (LinearLayout) view.findViewById(R.id.toolbar_linear4);
        linear5 = (LinearLayout) view.findViewById(R.id.toolbar_linear5);
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter implements AppConstants {
        ...
        public Fragment getItem(final int position) {
            switch (position) {
                case 0:
                    return new DiscoverFragement().newInstance(DEFAULT_MODE);
                case 1:
                    return new MapFragement();
                case 2:
                    return new PostFragement().newInstance(POST_MODE);
                case 3:
